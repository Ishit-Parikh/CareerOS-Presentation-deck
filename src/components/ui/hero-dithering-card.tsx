...
export function CTASection() {
  ...
  return (
    <section className="py-12 w-full flex justify-center items-center px-4 md:px-6">
      ...
      >
        <div className="relative overflow-hidden rounded-[48px] border border-border bg-surface shadow-sm min-h-[600px] md:min-h-[600px] flex flex-col items-center justify-center duration-500">
          <Suspense fallback={<div className="absolute inset-0 bg-muted-foreground/20" />}>
          ...
          <div className="relative z-10 px-6 max-w-4xl mx-auto text-center flex flex-col items-center">
            ...
            <button className="group relative inline-flex h-14 items-center justify-center gap-3 overflow-hidden rounded-sm bg-primary px-12 text-base font-medium text-background transition-all duration-300 hover:bg-primary/90 hover:scale-105 active:scale-95 hover:ring-4 hover:ring-primary/20">
